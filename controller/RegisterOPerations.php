...
class RegisterOperations {
    ...
    public static function getSomeData($user) {
    ...
    public static function signUp($user, $pass, $email, $type, $birthDay, $country, $phone, $image, $univers, $faculty, $gender) {
        ...
        $query = "INSERT INTO `users`(`username`, `password`, `email`, `type`, `birth_day`, "
                . "`country`, `phone`,`image`, `university`, `faculty`, `gender`) "
                . "VALUES ('$user', '$pass', '$email', '$type', '$birthDay', '$country', '$phone','$image', '$univers', '$faculty', '$gender')";
